...
const api: VanishAPI = {
  accounts: {
    ...
    identify: (accountId) => ipcRenderer.invoke('accounts:identify', accountId),
    bind: (accountId, username) => ipcRenderer.invoke('accounts:bind', accountId, username),
    signOut: (accountId) => ipcRenderer.invoke('accounts:sign-out', accountId),
